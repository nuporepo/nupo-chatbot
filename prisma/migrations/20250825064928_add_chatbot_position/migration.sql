...
CREATE TABLE "new_bot_configs" (
    ...
    "openaiApiKey" TEXT,
    "position" TEXT NOT NULL DEFAULT 'popup',
...
INSERT INTO "new_bot_configs" ("botName", "buttonText", "chatTitle", "createdAt", "enableAutoKnowledgeGeneration", "enableConversationAnalytics", "enableCustomerMemory", "enablePerformanceOptimization", "errorMessage", "id", "isActive", "maxTokens", "openaiApiKey", "placeholderText", "shopId", "systemPrompt", "temperature", "typingMessage", "updatedAt", "welcomeMessage") SELECT "botName", "buttonText", "chatTitle", "createdAt", "enableAutoKnowledgeGeneration", "enableConversationAnalytics", "enableCustomerMemory", "enablePerformanceOptimization", "errorMessage", "id", "isActive", "maxTokens", "openaiApiKey", "placeholderText", "shopId", "systemPrompt", "temperature", "typingMessage", "updatedAt", "welcomeMessage" FROM "bot_configs";
